...
<body>
            ...
            <div class="logo-header">
                ...
                <div>
                    <h1 class="mb-0 h2 fw-bold">
                        <i class="fas fa-edit me-2"></i>Edit Threat Information
                    </h1>
                    <p class="mb-0 opacity-90">Update threat, vulnerability, and prevention information</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container pb-5">
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="form-card">
                    <form action="{{ route('threat_library.update', $threat->threat_id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <select name="asset_id" id="asset_id" class="form-select @error('asset_id') is-invalid @enderror" required>
                                ...
                                @foreach($assets as $asset)
                                    <option value="{{ $asset->asset_id }}" {{ (old('asset_id', $threat->asset_id) == $asset->asset_id) ? 'selected' : '' }}>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="threat_name" id="threat_name" class="form-control @error('threat_name') is-invalid @enderror" value="{{ old('threat_name', $threat->threat_name) }}" placeholder="e.g., SQL Injection Attack" required>
                            @error('threat_name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="threat_description" id="threat_description" class="form-control @error('threat_description') is-invalid @enderror" placeholder="Describe the threat in detail..." required>{{ old('threat_description', $threat->threat_description) }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="vulnerabilities" id="vulnerabilities" class="form-control @error('vulnerabilities') is-invalid @enderror" placeholder="List the specific vulnerabilities that make this threat possible..." required>{{ old('vulnerabilities', $threat->vulnerabilities) }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="prevention_steps" id="prevention_steps" class="form-control @error('prevention_steps') is-invalid @enderror" placeholder="Provide step-by-step instructions on how to prevent or mitigate this threat..." required>{{ old('prevention_steps', $threat->prevention_steps) }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="severity-selector">
                                <div class="severity-option">
                                    <input type="radio" name="severity_level" id="low" value="Low" {{ old('severity_level', $threat->severity_level) == 'Low' ? 'checked' : '' }}>
                                ...
                                <div class="severity-option">
                                    <input type="radio" name="severity_level" id="medium" value="Medium" {{ old('severity_level', $threat->severity_level) == 'Medium' ? 'checked' : '' }}>
                                ...
                                <div class="severity-option">
                                    <input type="radio" name="severity_level" id="high" value="High" {{ old('severity_level', $threat->severity_level) == 'High' ? 'checked' : '' }}>
                                ...
                                <div class="severity-option">
                                    <input type="radio" name="severity_level" id="critical" value="Critical" {{ old('severity_level', $threat->severity_level) == 'Critical' ? 'checked' : '' }}>
                        ...
                        <div class="d-flex gap-3 justify-content-end mt-5">
                            ...
                            <button type="submit" class="btn btn-submit">
                                <i class="fas fa-save me-2"></i>Update Threat Information
                            </button>
                        </div>
                    </form>
                </div>
