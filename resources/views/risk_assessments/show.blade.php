                ...
                <div class="card shadow-sm border-0 mb-4">
                    ...
                    <ul class="list-group list-group-flush mb-3">
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <span class="badge bg-secondary px-3 py-1 fs-6">{{ $riskAssessment->status }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                    ...
                    @if(Auth::check() && Auth::user()->role === 'it_security_analyst')
                        <div class="card-body pt-0 d-grid gap-2">
                            <a href="{{ route('risk_assessments.edit', $riskAssessment->assessment_id) }}" class="btn btn-warning fw-bold text-dark w-100">
                                <i class="fa-solid fa-pen-to-square me-1"></i> Edit Assessment Info / Status
                            </a>
